      ...
      <Table celled>
        <Table.Header>
          <Table.Row>
            ...
            <Table.HeaderCell>Kutu-Birimi</Table.HeaderCell>
            <Table.HeaderCell>Fiyat</Table.HeaderCell>
            <Table.HeaderCell>Stok Adedi</Table.HeaderCell>
            <Table.HeaderCell>Sipraişte olan sayı</Table.HeaderCell>
            <Table.HeaderCell>Yeniden Sipraiş edilme seviyesi</Table.HeaderCell>
            <Table.HeaderCell>indirim</Table.HeaderCell>
        ...
        <Table.Body>
          ...
          {products.map(product => (
            <Table.Row key={product.id}>
              ...
              <Table.Cell>{product.reorderLevel}</Table.Cell>
              <Table.Cell>{product.discontinued}</Table.Cell>
